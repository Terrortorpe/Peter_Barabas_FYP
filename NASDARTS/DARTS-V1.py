...
def perturb_arch(arch, ratio=100):
    arch.arch_parameters[:, 0] += ratio * arch.arch_parameters[:, 0]
    arch.arch_parameters[:, 1] += ratio * arch.arch_parameters[:, 1]
...
def main(xargs):
    ...
    data_dir = os.path.join(current_dir, "AutoDL-Projects-main\configs\\nas-benchmark")
